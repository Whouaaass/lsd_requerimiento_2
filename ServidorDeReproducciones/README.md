...
```
java -Dspring.profiles.active=production -jar ./target/ServidorReproducciones-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=co.edu.unicauca.lsd/servidor-reproducciones
```
